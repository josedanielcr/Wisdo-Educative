...
class InstitutionService {
  ...
  getInstitutions() {
    return this.http.get(`${src_environments_environment_development__WEBPACK_IMPORTED_MODULE_1__.environment.apiUrl}/institutions`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(institutions => {
...
InstitutionService.ɵfac = function InstitutionService_Factory(t) {
  return new (t || InstitutionService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient));
};
InstitutionService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
...
/* harmony import */ var _helpers_adapters_interest_adapter_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/adapters/interest-adapter.service */ 366);
/* harmony import */ var _helpers_application_error_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/application-error.service */ 9234);
...
class InterestService {
  constructor(http, interestAdapterService, applicationErrorService) {
    this.http = http;
    this.interestAdapterService = interestAdapterService;
    this.applicationErrorService = applicationErrorService;
  }
  getInterests() {
    return this.http.get(`${src_environments_environment_development__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/interest`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.map)(interests => {
      let interestClient = [];
...
InterestService.ɵfac = function InterestService_Factory(t) {
  return new (t || InterestService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_helpers_adapters_interest_adapter_service__WEBPACK_IMPORTED_MODULE_1__.InterestAdapterService), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_helpers_application_error_service__WEBPACK_IMPORTED_MODULE_2__.ApplicationErrorService));
};
...
/* harmony import */ var _helpers_application_error_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/application-error.service */ 9234);
/* harmony import */ var _helpers_adapters_user_adapter_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/adapters/user-adapter.service */ 4158);
/* harmony import */ var _helpers_adapters_interest_adapter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/adapters/interest-adapter.service */ 366);
...
class UserService {
  constructor(http, applicationErrorService, userAdapterService, interestAdapterService) {
    this.http = http;
    this.applicationErrorService = applicationErrorService;
  ...
  validateUser() {
    return this.http.post(`${src_environments_environment_development__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/user/validate`, {}).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.map)(user => this.userAdapterService.adaptUserServerToClient(user)), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.catchError)(error => {
      throw this.applicationErrorService.parseHttpError(error);
    }));
  }
  setUserDetails(userSetupData) {
    return this.http.post(`${src_environments_environment_development__WEBPACK_IMPORTED_MODULE_0__.environment.apiUrl}/user/configuration`, this.adaptData(userSetupData)).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.map)(user => this.userAdapterService.adaptUserServerToClient(user)), (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.catchError)(error => {
      throw this.applicationErrorService.parseHttpError(error);
    }));
  }
...
UserService.ɵfac = function UserService_Factory(t) {
  return new (t || UserService)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_helpers_application_error_service__WEBPACK_IMPORTED_MODULE_1__.ApplicationErrorService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_helpers_adapters_user_adapter_service__WEBPACK_IMPORTED_MODULE_2__.UserAdapterService), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_helpers_adapters_interest_adapter_service__WEBPACK_IMPORTED_MODULE_3__.InterestAdapterService));
};
